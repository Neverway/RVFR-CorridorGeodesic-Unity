    ...
    public class WB_Extras3 : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            for (int i = 0; i < extraButtons.Length && i < levelpacks.Length; i++)
            {
                ...
                extraButtons[index].interactable = levelpacks[index].sceneList != null &&
                                                   levelpacks[index].sceneList.sceneNames.Length > 0;
                ...
                extraButtons[index].onClick.AddListener(() =>
                {
                    ...
                    OverrideLevelChangeExitWithSceneList levelOverrider =
                        new GameObject("Levelpack Level_Exit Overrider")
                            .AddComponent<OverrideLevelChangeExitWithSceneList>();
