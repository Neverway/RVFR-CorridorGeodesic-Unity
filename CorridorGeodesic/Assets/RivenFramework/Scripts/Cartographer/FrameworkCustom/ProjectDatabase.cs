...
// ---------------------------------------------------------
    ...
    {
        [Tooltip("The name of the group")] public string name;
...
// ---------------------------------------------------------
    ...
    public class SpotData
    {
        ...
        public string
            layerID; // WIP value to track actual layer name, instead of layer hierarchy position, to hopefully make level file corruption less common when changing what's stored in level files
