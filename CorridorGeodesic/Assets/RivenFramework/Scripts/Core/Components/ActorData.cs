...
namespace Neverway.Framework
{
    public class ActorData : MonoBehaviour
    {
        ...
        [HideInInspector]
        public List<VariableData> storedVariableData; // The variable's name, type, and value that we are storing in the actor data
        ...
        public void Inspect()
        {
            ...
            foreach (var scriptData in scriptDataList)
            {
                ...
                foreach (var variable in scriptData.exposedVariables)
                {
                    ...
                    if (field.GetValue(scriptData.targetScript) != null)
                        data.value = field.GetValue(scriptData.targetScript).ToString();
    ...
    public class ScriptData
    {
        ...
        public List<string>
            exposedVariables; // The variables from that script we want to be able to change in the runtime inspector
    }
