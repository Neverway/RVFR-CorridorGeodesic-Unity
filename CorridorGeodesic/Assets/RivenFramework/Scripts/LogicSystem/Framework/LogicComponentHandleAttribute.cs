...
namespace Neverway.Framework.LogicSystem
{
    ...
    public class LogicComponentHandleAttribute : Attribute
    {
        ...
        {
            IEnumerable<FieldInfo> handleFields = type.GetType()
            ...
            foreach (FieldInfo field in handleFields)
            {
                LogicComponentHandleAttribute[] allLogicHandles =
                    (LogicComponentHandleAttribute[])field.GetCustomAttributes(typeof(LogicComponentHandleAttribute),
                        true);
