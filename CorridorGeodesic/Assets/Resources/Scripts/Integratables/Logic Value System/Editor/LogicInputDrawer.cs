...
public class LogicInputDrawer : EasyDrawer
{
    ...
    public override DrawerObject OnGUIEasyDrawer(VerticalGroup contents)
    {
        ...
        contents.Add(new FittedLabel(Text_LinkedToOutput, new Property(property[sourceField])).Padding(4f));
    ...
    public string Text_LinkedToOutput => $"Link to {property[sourceField].FieldType.Generic(0).Generic(0).HumanName(true)} Output: ";
}